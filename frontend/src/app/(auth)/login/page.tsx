        ...
        <div className="flex min-h-screen items-center justify-center bg-gray-50 dark:bg-gray-900 px-4">
            <div className="w-full max-w-md space-y-8 bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg">
                <div className="text-center">
                    <div className="inline-flex items-center gap-2 rounded-full border border-primary/20 bg-primary/5 px-4 py-1.5 text-sm font-medium text-primary backdrop-blur-md animate-fade-in mb-4">
                        <Zap className="h-4 w-4 fill-primary animate-pulse" />
                        <span>Đăng nhập vào SportHub</span>
                    </div>
                    <h2 className="text-3xl font-black tracking-tight">
                        Chào mừng <span className="text-primary italic">trở lại</span>
                    </h2>
                ...
                <div className="grid grid-cols-2 gap-4">
                    <Button
                        type="button"
                        variant="outline"
                        className="w-full rounded-xl font-bold border-2 hover:border-primary/50"
                    ...
                    <Button
                        ...
                        variant="outline"
                        className="w-full rounded-xl font-bold border-2 hover:border-primary/50"
                        onClick={() => window.location.href = `${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:3000'}/auth/facebook`}
                    >
